    ...
    private getSortedData(data: AdaptersTableItem[]): AdaptersTableItem[] {
        ...
        return data.sort((a, b) => {
            ...
            switch (this.sort?.active) {
                ...
                case 'anbieter': return compare(a.imei, b.imei, isAsc);
                case 'fahrzeug': return compare(a.imei, b.imei, isAsc);
                case 'kunde': return compare(a.imei, b.imei, isAsc);
                case 'kennzeichen': return compare(a.imei, b.imei, isAsc);
                case 'vin': return compare(a.imei, b.imei, isAsc);
